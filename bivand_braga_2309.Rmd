...
- `stats::hclust` provides several hierachical clustering methods that work in a univariate setting, defaulting to complete clustering, but requires a dense distance matrix so is not suitable for large data sets
...
- Bagged clustering may also be used `e1071::bclust`, combining `kmeans` and hierachical clustering [@9b129f95b53b44cea1295b7a1168d832, @doi:10.1016/S1441-3582.04.70088-9, @doi:10.1177/0047287502239037]
